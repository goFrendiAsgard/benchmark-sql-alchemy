...
from common import connection_string, Buronan, tear_up, tear_down, session_scope, generate_data_buronan, get_chunked_data_buronan, create_insert_worker, create_select_worker
...
select_worker = create_select_worker(Session)
